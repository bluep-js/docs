...
**@bluepjs** - это библиотека визуального скриптового движка Java Script, вдохновленная системой Blueprints от Unreal Engine.
...
**@bluepjs** может быть интегрирован в проекты, требующие визуального написания сценариев поведения объектов проекта.
...
.. toctree::
   ...
   Вступление  <intro.rst>
   Документация пользователя <user.rst>
   Руководства разработчика <dev.rst>
